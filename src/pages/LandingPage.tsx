...
import logoUrlImg from "@/assets/Logo-1-opt.webp";
import logoModoOscuroUrlImg from "@/assets/Logo-MO-opt.webp";
    ...
    <LazyMotion features={loadFeatures} strict>
      <div className="min-h-screen bg-white dark:bg-slate-950 overflow-x-hidden transition-colors duration-300">
        ...
        <section className="flex items-center justify-center min-h-[calc(100vh-112px)] mt-[112px] py-12 px-8 md:px-24 lg:px-48 relative overflow-hidden bg-blue-50 dark:bg-slate-900">
          ...
          <div className="absolute inset-0 bg-black/50 dark:bg-black/65 hidden md:block" />
          ...
          <div className="container mx-auto relative z-10">
            ...
            >
              <m.div
                ...
                className="inline-block mb-6 px-4 py-2 bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-200 border dark:border-blue-500/30 md:bg-white/15 md:text-white md:border-white/30 md:backdrop-blur-sm rounded-full text-sm font-medium transition-colors"
              >
                Sistema de Gestión de Visitantes
              </m.div>

              <h1 className="text-5xl md:text-6xl lg:text-7xl mb-6 bg-gradient-to-r from-blue-600 to-purple-600 md:from-blue-300 md:to-purple-300 bg-clip-text text-transparent leading-tight transition-colors">
                Digitaliza la experiencia del Museo MUVI
              </h1>

              <p className="text-xl text-gray-600 dark:text-slate-400 md:text-white/80 md:dark:text-white/80 mb-10 max-w-2xl mx-auto transition-colors">
