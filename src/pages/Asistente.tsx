...
export const Asistente: React.FC = () => {
  return (
    <div className="container mx-auto p-4 sm:p-8 max-w-7xl flex flex-col min-h-[calc(100vh-6rem)] w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
