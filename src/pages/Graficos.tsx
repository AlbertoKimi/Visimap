  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-2 relative min-h-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        {/* Badge auto-refresh */}
        <div className="flex items-center gap-1.5 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-400 text-xs font-semibold px-3 py-1.5 rounded-full">
      ...
      <section className="sticky bottom-0 z-50 pt-4 pb-4">
        ...
        <div className="absolute inset-0 bg-slate-50/95 dark:bg-slate-950/95 backdrop-blur-md rounded-t-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.05)] -z-10" />
        <div className="flex items-center gap-2 mb-4">
          <div className="h-px flex-1 bg-slate-200 dark:bg-slate-800" />
          <span className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-widest px-2 flex items-center gap-1">
