...
export const EventModal: React.FC<EventModalProps> = ({
  ...
  return (
    <Modal
      isOpen={true} // El componente padre controla la visibilidad montando/desmontando
      onClose={onClose}
      title={title}
      footer={!confirmarCierre ? footer : null}
      size="md"
    >
      {confirmarCierre ? (
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 space-y-3 border dark:border-slate-800">
            ...
            <div className="flex gap-4">
              <div className="flex-1">
                ...
                <p className="text-slate-700 dark:text-300 font-medium capitalize">{tipoActual?.nombre || '—'}</p>
              </div>
