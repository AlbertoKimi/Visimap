...
export const ModalEditarCantidad: React.FC<ModalEditarCantidadProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-sm overflow-hidden transform animate-in zoom-in-95 duration-200 border border-slate-100">
        <div className="p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="relative group">
              <input
                ...
                className="w-full px-6 py-4 rounded-2xl bg-slate-50 border border-slate-100 text-slate-800 font-bold text-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all appearance-none"
                autoFocus
                min="0"
              />
            </div>
        ...
        <div className="p-6 bg-slate-50/50 flex gap-3 border-t border-slate-100">
          ...
          <button
            ...
            className="flex-1 px-6 py-3 rounded-2xl font-semibold text-white bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
          >
            Guardar
          </button>
        </div>
